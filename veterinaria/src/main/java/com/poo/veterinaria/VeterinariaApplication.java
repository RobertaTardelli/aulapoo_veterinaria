...
import com.poo.veterinaria.classes.Pessoa;
import com.poo.veterinaria.classes.Endereco;
...
public class VeterinariaApplication {
	...
	public static void main(String[] args) {
		...
		pessoa.listarCadastros();

		

		// ClinicaVeterinaria clinica1 = new ClinicaVeterinaria("01010101010/0001","Lovet");
		// ClinicaVeterinaria clinica2 = new ClinicaVeterinaria("02020202020202020/0001", "Patas e Pelos");
		

		// System.out.println("Nome da clinica: " + clinica1.getRazaoSocial());
		// System.out.println("Id da clinica: " + clinica1.getId());
		// System.out.println("------------------------------------------------");
		// System.out.println("Nome da clinica: " + clinica2.getRazaoSocial());
		// System.out.println("Id da clinica: " + clinica2.getId());
